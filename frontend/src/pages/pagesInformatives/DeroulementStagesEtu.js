  ...
  return (
    <div className="deroulementStagesEtudiant">
        ...
        <ul>
          <p>
            ...
            <a href="../documents/contact_employeurs.pdf">
              &laquo;contact&nbsp;employeurs&raquo;
            </a>{" "}
            . (Fichier en format{" "}
      ...
      <p>
        ...
        (stages), je vous invite à consulter les différentes sections du site
        Web dans le menu de droite.
      </p>
      <p>
      ...
      <p>
        ...
        la section "Les profils du programme informatique, les dates et les
        spécificités des stages".
      </p>
      <p>
        Le stagiaire est tenu de respecter l'horaire régulier de l'entreprise et
...
export default DeroulementStagesEtu;
