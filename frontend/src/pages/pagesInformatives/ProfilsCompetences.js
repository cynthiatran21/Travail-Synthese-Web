...
function ProfilsCompetences() {
  return (
    <div>
      <p>Liens avec ancrage pour afficher selon le profil </p>

      <p>
        Nos étudiants en Gestion de réseaux et sécurité ont suivi des cours leur
        permettant de:
      </p>
      <li>
      ...
      <li>
        {" "}
        détecter les problèmes, en dégager la structure et trouver les solutions
        logiques
      </li>
      <li>
        {" "}
        effectuer les jeux d’essai et la mise au point des programmes et des
        systèmes
      </li>
      <li>
        {" "}
