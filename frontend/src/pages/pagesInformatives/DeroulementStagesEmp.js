...
<p>Sur réception de ce formulaire, le coordonnateur des stages
  ...
  <p>Veuillez vous référez à la page Profil de sortie pour connaître le profil de sortie et les compétences des étudiants.</p>
  </div>
  );
}

export default DeroulementStagesEmp;
